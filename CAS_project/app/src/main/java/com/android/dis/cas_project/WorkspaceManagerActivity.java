...
public class WorkspaceManagerActivity extends Activity {
        ...
        try {
            ...
            for (int i = 0; i < urls.length(); i++) {
                ...
                if(urls.getJSONObject(i).getString("type").toString().equals("водитель"))
                {
                    ...
                    adapter = new MySimpleAdapter(WorkspaceManagerActivity.this, myBooks, R.layout.list,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.workspace_manager);
        ...
        gps = new GPSTracker(WorkspaceManagerActivity.this);
        GPSsetting();
        ...
        /*btnmaps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(WorkspaceManagerActivity.this, MapsActivity.class);
                intent.putExtra("dolgota", dol);
                intent.putExtra("shirota", shi);
        ...
        map_driv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    class RequestTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            dialog = new ProgressDialog(WorkspaceManagerActivity.this);
    ...
    class RequestTask_version extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            dialog2 = new ProgressDialog(WorkspaceManagerActivity.this);
